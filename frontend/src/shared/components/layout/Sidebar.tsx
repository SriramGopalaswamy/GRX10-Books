...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onChangeView, onCollapseChange, isCollapsed: externalCollapsed }) => {
  ...
  return (
    <div
      className={`grx-sidebar bg-grx-primary dark:bg-grx-primary-900 text-white h-screen flex flex-col fixed left-0 top-16 z-40 overflow-y-auto transition-all duration-300 ${

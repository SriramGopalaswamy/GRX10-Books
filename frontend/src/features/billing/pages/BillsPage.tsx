    ...
    return (
      <div className="max-w-4xl mx-auto space-y-6 grx-animate-fade-in-up">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-grx-text dark:text-white">New Bill</h2>
            <p className="text-grx-muted dark:text-grx-muted">Record a new vendor bill</p>
          </div>
        </div>
            ...
            <div className="bg-grx-bg dark:bg-grx-dark rounded-lg border border-grx-primary-100 dark:border-grx-primary-800 overflow-hidden">
              <table className="w-full text-sm">
                      ...
                      <tr key={line.id}>
                        ...
                        <td className="px-4 py-2">
                          <input
                            ...
                            min="1"
                            className="w-20 border border-grx-primary-100 dark:border-grx-primary-700 rounded px-2 py-1.5 text-sm text-right bg-white dark:bg-grx-primary-800 text-grx-text dark:text-white"
                          />
                        </td>
                        <td className="px-4 py-2">
                          <input
                            ...
                            min="0"
                            step="0.01"
                            className="w-28 border border-grx-primary-100 dark:border-grx-primary-700 rounded px-2 py-1.5 text-sm text-right bg-white dark:bg-grx-primary-800 text-grx-text dark:text-white"
                          />
                        </td>
                        <td className="px-4 py-2 text-right font-mono text-sm text-grx-text dark:text-grx-primary-200">
                ...
                <tfoot className="bg-grx-primary-50 dark:bg-grx-dark border-t-2 border-grx-primary-100 dark:border-grx-primary-700">
                  <tr>
                    <td colSpan={4} className="px-4 py-3 text-sm font-bold text-right text-grx-text dark:text-white">
                      Subtotal
                    </td>
  ...
  return (
    <div className="space-y-6 grx-animate-fade-in-up">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-grx-text dark:text-white">Bills</h2>
      ...
      {aging && (
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
          <div className="grx-glass-card p-4 rounded-xl border border-grx-primary-100 dark:border-grx-primary-800">
            <p className="text-xs text-grx-muted dark:text-grx-muted mb-1">Current</p>
            <p className="text-lg font-bold text-grx-text dark:text-white">
              {formatINR(aging.current)}
            </p>
          </div>
          <div className="grx-glass-card p-4 rounded-xl border border-grx-primary-100 dark:border-grx-primary-800">
            <p className="text-xs text-grx-muted dark:text-grx-muted mb-1">1-30 Days</p>
            <p className="text-lg font-bold text-yellow-600 dark:text-yellow-400">
              {formatINR(aging.thirtyDays)}
            </p>
          </div>
          <div className="grx-glass-card p-4 rounded-xl border border-grx-primary-100 dark:border-grx-primary-800">
            <p className="text-xs text-grx-muted dark:text-grx-muted mb-1">31-60 Days</p>
            <p className="text-lg font-bold text-orange-600 dark:text-orange-400">
              {formatINR(aging.sixtyDays)}
            </p>
          </div>
          <div className="grx-glass-card p-4 rounded-xl border border-grx-primary-100 dark:border-grx-primary-800">
            <p className="text-xs text-grx-muted dark:text-grx-muted mb-1">61-90 Days</p>
            <p className="text-lg font-bold text-red-600 dark:text-red-400">
              {formatINR(aging.ninetyDays)}
            </p>
          </div>
          <div className="grx-glass-card p-4 rounded-xl border border-grx-primary-100 dark:border-grx-primary-800">
            <p className="text-xs text-grx-muted dark:text-grx-muted mb-1">90+ Days</p>
          ...
          <div className="bg-grx-primary-50 dark:bg-grx-primary-900/20 p-4 rounded-xl border border-grx-primary-200 dark:border-grx-primary-800">
            <p className="text-xs text-grx-primary-600 dark:text-grx-primary-400 mb-1">Total AP</p>
            <p className="text-lg font-bold text-grx-primary-900 dark:text-grx-primary-100">
      ...
      <div className="grx-glass-card rounded-xl overflow-hidden">
        ...
        {loading ? (
          <div className="flex items-center justify-center h-64">
            ...
            <span className="ml-2 text-grx-muted dark:text-grx-muted">Loading bills...</span>
          </div>
        ) : bills.length === 0 ? (
          <div className="p-12 text-center">
            <FileText size={48} className="mx-auto text-grx-primary-200 dark:text-grx-muted mb-4" />
            <p className="text-grx-muted dark:text-grx-muted">No bills found.</p>
          </div>
        ) : (
          <table className="w-full text-sm text-left">
            ...
            <tbody className="divide-y divide-grx-primary-50 dark:divide-grx-primary-800 bg-white dark:bg-grx-dark-surface">
              {bills.map((bill) => (
                <tr key={bill.id} className="hover:bg-grx-bg dark:hover:bg-grx-primary-800">
                  ...
                  <td className="px-6 py-4 text-grx-muted dark:text-grx-muted">{bill.date}</td>

  ...
  if (isCreating) {
    return (
      <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
         ...
         <div className="bg-white dark:bg-grx-dark-surface rounded-xl shadow-sm border border-grx-primary-100 dark:border-grx-primary-800 p-6 space-y-6">
        ...
        <div className="p-4 border-b border-grx-primary-50 dark:border-grx-primary-800 flex flex-wrap gap-4 justify-between items-center bg-grx-bg/50 dark:bg-grx-dark/50">
          <div className="relative max-w-sm w-full">
            ...
            <input type="text" placeholder="Search..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full pl-10 pr-4 py-2 rounded-lg border border-grx-primary-100 dark:border-grx-primary-700 bg-white dark:bg-grx-primary-800 text-grx-text dark:text-white focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400 outline-none text-sm" />
          </div>
        </div>

    ...
    return (
      <div className="max-w-5xl mx-auto space-y-6 animate-fade-in">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">New Sales Order</h2>
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400">Manage customer orders</p>
        </div>
        <button
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        {loading ? (
          <div className="flex items-center justify-center h-64">
            ...
            <span className="ml-2 text-slate-500 dark:text-slate-400">Loading sales orders...</span>
          </div>
        ) : salesOrders.length === 0 ? (
          <div className="p-12 text-center">
            <FileText size={48} className="mx-auto text-slate-300 dark:text-slate-600 mb-4" />
            <p className="text-slate-500 dark:text-slate-400">No sales orders found.</p>
          </div>
        ) : (
